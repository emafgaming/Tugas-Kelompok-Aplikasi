...
public class KartuAnggotaPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        cmbAnggota.setPreferredSize(new Dimension(300, 32));
        loadAnggotaCombo();
        ...
        toolPanel.add(lblPilih);
        toolPanel.add(cmbAnggota);
        toolPanel.add(btnPreview);
        toolPanel.add(btnCetak);
        toolPanel.add(btnSimpan);
