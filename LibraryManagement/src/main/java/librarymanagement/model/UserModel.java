...
public class UserModel {
    ...
    private String role;
    private boolean isDemo; // Flag untuk akun demo
    ...
    public UserModel(int idUser, String username, String password, String role, boolean isDemo) {
        this.idUser   = idUser;
        this.username = username;
        this.password = password;
        this.role     = role;
    ...
    public UserModel login(String username, String password) {
        ...
        if ("demo".equalsIgnoreCase(username) && "demo123".equals(password)) {
            ...
            System.out.println(">>> Login berhasil! Mode: DEMO (Read-Only)");
            return demoUser;
        }
